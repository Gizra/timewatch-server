[![Build Status](https://travis-ci.org/Gizra/timewatch-server.svg)](https://travis-ci.org/Gizra/timewatch-server)

# Drupal 7 - Install Profile Timewatch
...
Clone the project from [GitHub](https://github.com/Gizra/timewatch).
...
6. Makes a symlink within the /www/profiles directory to the /timewatch
   directory.
7. Run the Drupal installer (Drush) using the Timewatch profile.
